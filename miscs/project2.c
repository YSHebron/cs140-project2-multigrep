...
#define MAXPATH 260 // use 260 to be safe
#define DEBUG 0     // Set to 1 for debugging messages, 0 for none (set to 0 before submission!)

// NOTE: Change task char * abspath to char abspath[MAXPATH] to avoid memory overlap

pthread_mutex_t lock1, lock2;
pthread_cond_t fill;    // status variable hasContent linked to this
int count = 0;
int busyThreads = 0;
...
// Note! It's actually safer to do count++/-- inside enq and deq, don't waste the locks!
